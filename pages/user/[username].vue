            ...
            <ul role="list" class="border border-gray-200 divide-y divide-gray-200 rounded-md">
              <li class="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                ...
                <div class="flex-shrink-0 ml-4">
                  <a href="#" class="font-medium text-rose-600 hover:text-rose-500"> Download </a>
                </div>
              </li>
              <li class="flex items-center justify-between py-3 pl-3 pr-4 text-sm">
                <div class="flex items-center flex-1 w-0">
  ...
  <div v-else>
    <div class="py-16">
      <div class="text-center">
        <p class="text-sm font-semibold tracking-wide uppercase text-rose-600">404 error</p>
        <h1 class="mt-2 text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">User not found.</h1>
        <p class="mt-2 text-base text-gray-500">Sorry, we couldn’t find the user you’re looking for.</p>
        <div class="mt-6">
          <nuxt-link to="/" class="text-base font-medium text-rose-600 hover:text-rose-500">Go back home<span aria-hidden="true"> &rarr;</span></nuxt-link>
        </div>
      </div>
    </div>
  </div>
